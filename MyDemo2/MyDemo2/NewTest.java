...
//		pin.sendKeys("500010");
//		WebElement Uname = KC.findElement(By.xpath("//input[text() = 'email']")).sendKeys('wraith');
//		WebElement pass = KC.findElement(By.xpath("//input[text() = 'password']")).sendKeys('king');
...
//		WebElement submit = KC.findElement(By.XPath("//input[@name = \"register\"]"))
		System.out.println("this is another file test case");
